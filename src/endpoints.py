...
from services import insert_questions, get_last_question
...
async def add_questions(
    ...
    try:
        ...
        await insert_questions(session=session, http_client=http_client, question_num=question_in.question_num)
        return question or {}
